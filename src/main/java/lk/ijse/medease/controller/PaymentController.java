...
public class PaymentController {
    ...
    public String addPayment(PaymentDTO paymentDTO) throws SQLException, ClassNotFoundException {
    ...
    public String deletePayment(int paymentId) throws SQLException, ClassNotFoundException {
